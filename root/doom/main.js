...
output.style.display = "none"; // hide the output by default
...
WebAssembly.instantiateStreaming(fetch('/root/doom/doom.wasm'), importObject)
    .then(obj => {
    ...
    const printFocusInHint = function(e) {
        focushint.innerText = "Keyboard events will be captured as long as canvas has focus (it does)";
